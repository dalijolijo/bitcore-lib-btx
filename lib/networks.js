...
addNetwork({
  ...
  port: 8555, //standard port
  dnsSeeds: [
    '37.120.190.76','185.194.140.60','188.71.223.206','37.120.190.76'
  ]
});
...
// Add configurable values for testnet
var TESTNET = {
  PORT: 8666, //standard port
  NETWORK_MAGIC: BufferUtil.integerAsBuffer(0xfdd2c8f1),
  DNS_SEEDS: [
    '37.120.186.85','51.15.84.165','212.47.246.150'
  ]
};
...
// Add configurable values for regtest
var REGTEST = {
  PORT: 18444,
